---
name: frontend
description: 'A comprehensive guide for GitHub Copilot to craft immersive, high-performance web experiences with advanced motion, typography, and architectural craftsmanship. Use when asked to build landing pages, static websites, premium UI components, or any Awwwards-style immersive frontend.'
metadata:
  source: 'https://github.com/github/awesome-copilot/tree/main/skills/premium-frontend-ui'
  original_author: 'Utkarsh Patrikar'
  original_author_url: 'https://github.com/utkarsh232005'
---
